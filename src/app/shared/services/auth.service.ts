...
export class AuthService {
  ...
  login(username: string, password: string): Observable<any> {
    return this.httpClient.post(environment.apiUrl + '/api/Authenticate/login', { 
      username, password 
    }, httpOptions);
  }
  ...
  ForgetPassword(email: string): Observable<any>{
    return this.httpClient.post(environment.apiUrl + '/api/Authenticate/ForgetPassword', {
    email}, httpOptions);
  }

  ResetPassword(token:string, email: string, newPassword:string, password:string): Observable<any>{
    return this.httpClient.post(environment.apiUrl + '/api/Authenticate/ResetPassword', {
